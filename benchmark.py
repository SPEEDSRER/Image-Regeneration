...
class ImageRegenerationBenchmark:
    ...
    def __init__(
        ...
        self.iut_generator = IUTGenerator(model_type='openai', api_key=openai_api_key)
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Run T2I model benchmark")
    parser.add_argument("--model", type=str, required=True,
                        help="Name of T2I model to evaluate")
    parser.add_argument("--dataset", type=str, required=True,
                        choices=["style", "content"],
                        help="Dataset to evaluate on (style/content)")
    ...
    sd_model_path = ''
    openai_api_key = ''
    model_manager.set_model_type(model_type, sd_model_path)
